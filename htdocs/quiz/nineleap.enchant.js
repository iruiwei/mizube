...
enchant.nineleap = { assets: ['baru3.jpg', 'http://r.jsgames.jp/samples/atlasx/end.png'] };
enchant.nineleap.Game = enchant.Class.create(enchant.Game, {
    initialize: function(width, height) {
        ...
        this.addEventListener('load', function() {
            ...
            this.startScene.image = this.assets['baru3.jpg'];
            ...
            this.endScene.image = this.assets['http://r.jsgames.jp/samples/atlasx/end.png'];
